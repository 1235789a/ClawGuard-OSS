...
const Home = (): JSX.Element => {
  const defaultPlaceholder = 'e.g. yourstore.com';
    ...
    <HomeContainer>
      ...
      <UserInputMain onSubmit={formSubmitEvent}>
        <a href="/">
          <Heading as="h1" size="xLarge" align="center" color={colors.primary}>
            <img width="64" src="/favicon.svg" alt="MultiHub Site Check Icon" />
            MultiHub Site Check
          </Heading>
        </a>
        <Input
      ...
      <SponsorCard>
        <Heading as="h2" size="small" color={colors.primary}>
          Free website check for independent businesses
        </Heading>
        <p>
          Review technical, trust and discoverability signals without creating an account. After the scan, MultiHub GEO can help you turn the findings into practical improvements.{' '}
          <a target="_blank" rel="noreferrer" href={brand.website}>Learn more</a>.
        </p>
      </SponsorCard>
      <SiteFeaturesWrapper>
        ...
        <div className="links">
          ...
          >
            <Button>Free Discovery Review</Button>
          </a>
          <a
            target="_blank"
            rel="noreferrer"
            href={brand.facebookGroup || brand.website}
